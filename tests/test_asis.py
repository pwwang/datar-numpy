...
@pytest.mark.parametrize('fn, x, expected', [
    ...
    (as_date, "2002-01-01", datetime.date(2002, 1, 1)),
    (as_date, "2002-01-01 00:00:00", datetime.datetime(2002, 1, 1, 0, 0, 0)),
    (as_double, 1, 1),
    (as_double, 1.0, 1.0),
    (as_double, "1", 1.0),
    (as_integer, 1, 1),
...
def test_is_element():
    ...
    assert_iterable_equal(is_element([1, 2], np.array([1, 2, 3])), [True, True])
